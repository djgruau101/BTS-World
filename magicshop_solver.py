...
ms7m2 = magicshop(7, 2, 1, 2, 4, 3, 7.77, 1.98, 0.84, 0.56, "JK")
ms7m4 = magicshop(7, 4, 3, 1, 4, 2, 5.88, 3.51, 2.67, 0.22, "JH", "JK")
ms7m6 = magicshop(7, 6, 1, 2, 3, 4, 8.14, 5.01, 0.81, 0.17, "JK")
ms7m8 = magicshop(7, 8, 4, 1, 3, 2, 7.12, 1.11, 0.51, 0.1, "RM", "JK")
ms7m10 = magicshop(7, 10, 1, 3, 2, 4, 5.11, 2.11, 0.71, 0.56, "JK", "JK")
ms7m12 = magicshop(7, 12, 3, 4, 1, 2, 1.39, 1.11, 0.83, 0.15, "SG", "JK")
ms7m15 = magicshop(7, 15, 2, 4, 1, 3, 6.15, 4.43, 1.03, 0.5, "JM", "JK")
ms7m18 = magicshop(7, 18, 4, 2, 3, 1, 6.13, 0.59, 0.13, 0.04, "JM")
ms7m19 = magicshop(7, 19, 3, 4, 2, 1, 3.33, 1.11, 0.33, 0.11, "V", "JK")
ms7m21 = magicshop(7, 21, 2, 4, 3, 1, 7.81, 1.18, 1.05, 0.99, "V", "JK")
...
def msmainmenu():
    ...
    ms_m = {"1-2":(ms1m2,16506,1), "1-4":(ms1m4,52129,3), "1-6":(ms1m6,87653,4),
            ...
            "7-2":(ms7m2,71328,4), "7-4":(ms7m4,124552,4), "7-6":(ms7m6,123684,2),
            "7-8":(ms7m8,54045,3), "7-10":(ms7m10,54672,4), "7-12":(ms7m12,18342,4),
            "7-15":(ms7m15,33137,2), "7-18":(ms7m18,107765,3), "7-19":(ms7m19,13126,2),
            "7-21":(ms7m21,92440,3)}
